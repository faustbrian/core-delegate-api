...
const register = async (server, options) => {
    const routes = [
        ...
        { method: 'GET', path: '/{delegate}/voters/{voter}/transactions/sent', ...voters.transactions },
        { method: 'GET', path: '/{delegate}/voters/{voter}/transactions/received', ...voters.transactions }
    ]
